...
void glClearNamedBufferSubDataEXT(GLuint buffer, GLenum[Main] internalformat, GLenum[Main] format, GLenum[Main] type, GLsizeiptr offset, GLsizeiptr size, const void * data);
